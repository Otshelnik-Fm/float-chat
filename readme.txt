...
* Возможность вывести кнопку вызова всплывающего чата: автоматически или шорткодом
...
Добавлен шаблон <code>fchat-guest-info.php</code> - как раз выводящий информацию для гостей. Можете поменять текст, вставить изображение, свою вёрстку.
